...
# ====================== COMMUNITY & LIVE (Pro locked) ======================
    ...
    if is_pro:
        ...
        st.markdown('<div class="card"><h3>🔒 Pro Feature</h3><p>Unlock full Community, Live Rooms, Advanced Sentiment, and more.</p><h2>$12.99 / month</h2><button style="background:#00FF88;color:black;padding:12px 32px;border:none;border-radius:12px;font-weight:700;">Upgrade to Pro</button></div>', unsafe_allow_html=True)

st.sidebar.success("Premium Experience")
st.caption("Pull to refresh • Pro unlocks everything")
